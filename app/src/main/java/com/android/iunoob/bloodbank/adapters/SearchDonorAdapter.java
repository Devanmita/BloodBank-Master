...
public class SearchDonorAdapter extends RecyclerView.Adapter<SearchDonorAdapter.PostHolder> {
    ...
    public void onBindViewHolder(PostHolder postHolder, int i) {
        ...
        // The following fields are removed as the achievement feature is disabled.
        postHolder.totaldonate.setVisibility(View.GONE);
        postHolder.posted.setVisibility(View.GONE);
